...
$stats = $connection->prepare("insert into statystyki
                                    ...
                                    values ('','69','FWL_typer_zalogowani','$czas_logowania','$data_logowania', '$_SESSION[userId]')");
$stats->execute();
//koniec statystyki	*/
...
//                if ($homeBet > $guestBet) {
 ...
 //               if ($homeBet == $guestBet) {
    ...
    $usersTypes = Typer::getUsersTypes($id,3); //remisy
    if ($max[0] == 1) {
        echo "bold ";
    }
    echo "\" >
...
//                if ($homeBet < $guestBet) {
    ...
    $usersTypes = Typer::getUsersTypes($id,2);
    if ($max[0] == 2) {
        echo "bold ";
    }
    echo "\" >
